'''Main description: This code describes all the buttons that will be on the dashboard, how the data entered will be treated and what will happen when we press 
   the loan request button'''
